...
from tests._internal.proxy.lib.routers.test_model_proxy import make_endpoint_model, make_model
...
async def test_persist_repo(tmp_path: Path) -> None:
    ...
    assert await repo.list_models("proj-2") == [model_2]
